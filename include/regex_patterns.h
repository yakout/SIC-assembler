...
#ifndef SIC_ASSEMBLER_REGEX_PATTERNS_H__
#define SIC_ASSEMBLER_REGEX_PATTERNS_H__
...
#define LC_INSTRUCTION_WITHOUT_OPERAND_WITHOUT_COMMENT "(?:^)([0-9a-f]{4})(?:\\s{3})\\s(.{8})\\s(.{1,6})(?:$)"
...
#define LITERAL_FORMAT "^([0-9a-f]{4})\\s{4}\\*\\s{8}([=](?:[[0-9]+|[cC]['][a-zA-Z]+[']|[xX]['][0-9a-fA-F]+[']))$"

#endif // SIC_ASSEMBLER_REGEX_PATTERNS_H__
